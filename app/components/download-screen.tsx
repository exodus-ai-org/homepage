...
const BASE = `https://github.com/exodus-ai-org/exodus/releases/download/${VERSION}`
...
const platforms = [
  {
    ...
    primary: {
      ...
      url: `${BASE}/exodus-1.9.0.dmg`
    },
    secondary: [
      {
        label: 'Apple Silicon (.zip)',
        url: `${BASE}/Exodus-1.9.0-arm64-mac.zip`
      }
    ]
  },
  {
    ...
    primary: {
      ...
      url: `${BASE}/exodus-1.9.0-setup.exe`
    },
    secondary: []
  },
  {
    ...
    primary: {
      ...
      url: `${BASE}/exodus-1.9.0.AppImage`
    },
    secondary: [
      { label: '.deb package', url: `${BASE}/exodus_1.9.0_amd64.deb` },
      { label: 'Snap package', url: `${BASE}/exodus_1.9.0_amd64.snap` }
    ]
  }
]
          ...
          {platforms.map((platform, i) => (
            ...
            >
              ...
              <div className="mb-6 flex items-center gap-3">
                <platform.icon
                  className={`h-9 w-9 ${platform.iconColor}`}
                />
                <div>
              ...
              <a
                ...
                className="mb-5 flex items-center justify-between rounded-2xl bg-zinc-900 px-5 py-4 transition-all duration-200 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100"
              >
                <div>
